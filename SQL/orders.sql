...
/*!40000 ALTER TABLE `orders`
    DISABLE KEYS */;
INSERT INTO `orders` (`id`, `total_price`, `create_date`, `status`, `user_id`, `order_type`, `order_name`,
...
/*!40000 ALTER TABLE `orders_goods`
    DISABLE KEYS */;
INSERT INTO `orders_goods` (`id`, `order_id`, `goods_id`, `goods_type`, `goods_name`, `goods_price`, `goods_detail`)
...
/*!40000 ALTER TABLE `pay_record`
    DISABLE KEYS */;
INSERT INTO `pay_record` (`id`, `pay_no`, `out_pay_no`, `out_pay_channel`, `order_id`, `order_name`, `total_price`,
