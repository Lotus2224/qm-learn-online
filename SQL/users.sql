...
/*!40000 ALTER TABLE `company`
    DISABLE KEYS */;
INSERT INTO `company` (`id`, `linkname`, `name`, `mobile`, `email`, `intro`, `logo`, `identitypic`, `worktype`,
                       `businesspic`, `status`)
...
(
    ...
    KEY `FK_company_user_user_id` (`user_id`) USING BTREE,
    CONSTRAINT `FK_company_user_company_id` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT `FK_company_user_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb3
  ROW_FORMAT = DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `company_user`
    DISABLE KEYS */;
...
/*!40000 ALTER TABLE `menu`
    DISABLE KEYS */;
INSERT INTO `menu` (`id`, `code`, `p_id`, `menu_name`, `url`, `is_menu`, `level`, `sort`, `status`, `icon`,
                    `create_time`, `update_time`)
VALUES ('', 'teachmanager_course_pic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-28 08:35:25',
        '2022-09-28 08:35:25'),
       ('000000000000000000', 'root', '0', '系统根目录', NULL, '0', 0, 1, '1', NULL, '2022-09-28 08:35:25',
        '2022-09-28 08:35:25'),
       ('111111111111111111', 'sysmanager', '000000000000000000', '系统管理', NULL, '1', 1, 10, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('222222222222222222', 'teachmanager', '000000000000000000', '教学管理', NULL, '1', 1, 2, '1', NULL,
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('893288715881807872', 'sysmanager_user', '111111111111111111', '用户管理', NULL, '1', 2, 1, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('893304960282787840', 'sysmanager_user_add', '893288715881807872', '添加用户', NULL, '1', 3, 1, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894396523532517376', 'sysmanager_user_edit', '893288715881807872', '用户修改', NULL, '0', 3, 1, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894473486712438784', 'sysmanager_user_view', '893288715881807872', '用户列表', NULL, '1', 3, 2, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894473651837992960', 'sysmanager_user_delete', '893288715881807872', '用户删除', NULL, '0', 3, 4, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894475142061621248', 'sysmanager_role', '111111111111111111', '角色管理', NULL, '1', 2, 2, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894475827880656896', 'sysmanager_role_add', '894475142061621248', '角色添加', NULL, '0', 3, 1, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894475985452269568', 'sysmanager_role_edit', '894475142061621248', '角色编辑', NULL, '0', 3, 2, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894476118730473472', 'sysmanager_role_delete', '894475142061621248', '角色删除', NULL, '0', 3, 2, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894476276402749440', 'sysmanager_role_permission', '894475142061621248', '角色配权', NULL, '0', 3, 3, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894476950951690240', 'sysmanager_menu', '111111111111111111', '菜单管理', NULL, '1', 2, 2, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894477107919323136', 'sysmanager_menu_add', '894476950951690240', '菜单添加', NULL, '0', 3, 1, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894477244926263296', 'sysmanager_menu_edit', '894476950951690240', '菜单编辑', NULL, '0', 3, 2, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894477420512411648', 'sysmanager_menu_delete', '894476950951690240', '菜单删除', NULL, '0', 3, 2, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894477851082883072', 'sysmanager_doc', '111111111111111111', '文档查询', NULL, '1', 2, 9, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894477995903811584', 'sysmanager_log', '111111111111111111', 'add', NULL, '1', 2, 10, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('894752734459199488', 'sysmanager_company', '111111111111111111', '机构管理', NULL, '1', 1, 1, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('903459378655395840', 'sysmanager_user_resetpwd', '893288715881807872', '密码重置', NULL, '1', 3, 2, '1', '',
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('903459378655395841', 'teachmanager_course', '222222222222222222', '课程管理', NULL, '1', 2, 1, '1', NULL,
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('903459378655395842', 'teachmanager_course_add', '903459378655395841', '添加课程', NULL, '1', 3, 1, '1', NULL,
        '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('903459378655395843', 'teachmanager_course_del', '903459378655395841', '删除课程', NULL, NULL, NULL, NULL, NULL,
        NULL, '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('903459378655395845', 'teachmanager_course_market', '903459378655395841', '编辑课程营销信息', NULL, NULL, NULL,
        NULL, NULL, NULL, '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('903459378655395846', 'teachmanager_course_base', '903459378655395841', '编辑课程基础信息', NULL, NULL, NULL,
        NULL, NULL, NULL, '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('903459378655395847', 'teachmanager_course_plan', '903459378655395841', '编辑课程计划', NULL, NULL, NULL, NULL,
        NULL, NULL, '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('903459378655395848', 'teachmanager_course_publish', '903459378655395841', '发布课程', NULL, NULL, NULL, NULL,
        NULL, NULL, '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
       ('903459378655395849', 'teachmanager_course_list', '903459378655395841', '我的课程', NULL, NULL, NULL, NULL,
        NULL, NULL, '2022-09-28 08:35:25', '2022-09-28 08:35:25'),
...
/*!40000 ALTER TABLE `permission`
    DISABLE KEYS */;
INSERT INTO `permission` (`id`, `role_id`, `menu_id`, `create_time`)
...
/*!40000 ALTER TABLE `role`
    DISABLE KEYS */;
INSERT INTO `role` (`id`, `role_name`, `role_code`, `description`, `create_time`, `update_time`, `status`)
...
(
    ...
    CONSTRAINT `fk_teacher_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb3
  ROW_FORMAT = DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `user`
    DISABLE KEYS */;
INSERT INTO `user` (`id`, `username`, `password`, `salt`, `wx_unionid`, `nickname`, `name`, `userpic`, `company_id`,
...
VALUES ('17b9d8be-cef3-400c-bec5-1478a6ef7ddc', 'o5PB1sytMXJGGv2x5OBP2uMzCpS8', 'o5PB1sytMXJGGv2x5OBP2uMzCpS8', NULL,
       ...
       ('48', 'admin', '$2a$10$TJ4TmCdK.X4wv/tCqHW14.w70U3CC33CeVncD3SLmyMXMknstqKRe', NULL, NULL, NULL, '系统管理员',
        NULL, NULL, '101003', NULL, '1', NULL, NULL, NULL, '1', '2022-09-28 08:32:03', NULL),
       ('49', 'Lotus', '$2a$10$wLAyszibjsvqjEFLtgo43eJxKtYkD7wcZZhzNYNX/piFXsClxEERS', NULL, NULL, NULL, 'test02', NULL,
        NULL, '101002', NULL, '1', '', '12345', NULL, '1', '2022-09-28 08:32:03', NULL),
...
/*!40000 ALTER TABLE `user_role`
    DISABLE KEYS */;
INSERT INTO `user_role` (`id`, `user_id`, `role_id`, `create_time`, `creator`)
