...
public class BankCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(System.getProperty("user.dir") + "/learn-online-generator/src/main/java");
        gc.setAuthor("Lotus");
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://116.198.224.127:3306/" + SERVICE_NAME
