package com.qm.media.service.impl;
...
import com.qm.base.model.RestResponse;
import com.qm.media.mapper.MediaFilesMapper;
import com.qm.media.mapper.MediaProcessMapper;
...
import com.qm.media.model.po.MediaProcess;
...
public class MediaFileServiceImpl implements MediaFileService {
    ...
    public UploadFileResultDto uploadFile(Long companyId, UploadFileParamsDto uploadFileParamsDto, byte[] bytes, String folder, String objectName) {
        ...
        try {
            ...
            LearnOnlineException.cast("上传过程中出错" + e.getMessage());
        }
        return null;
    }
    ...
    public MediaFiles addMediaFilesToDB(Long companyId, UploadFileParamsDto uploadFileParamsDto, String objectName, String fileMD5, String bucket) {
        ...
        if ("video/x-msvideo".equals(contentType)) {
            ...
            if (processInsert <= 0) {
                LearnOnlineException.cast("保存avi视频到待处理表失败");
            }
        }
        return mediaFiles;
    }
    ...
    public RestResponse<Boolean> mergeChunks(Long companyId, String fileMd5, int chunkTotal, UploadFileParamsDto uploadFileParamsDto) {
        ...
        try {
            ...
            LearnOnlineException.cast("创建合并临时文件出错");
        }
        try {
            // 缓冲区
            ...
            try (RandomAccessFile raf_write = new RandomAccessFile(mergeFile, "rw")) {
                ...
                LearnOnlineException.cast("合并文件过程中出错");
            }
            ...
            try (FileInputStream mergeInputStream = new FileInputStream(mergeFile)) {
                ...
                if (!fileMd5.equals(mergeMd5)) {
                    LearnOnlineException.cast("合并文件校验失败");
                }
                log.debug("合并文件校验通过：{}", mergeFile.getAbsolutePath());
            } catch (Exception e) {
                LearnOnlineException.cast("合并文件校验异常");
            }
            ...
            if (mediaFiles == null) {
                LearnOnlineException.cast("媒资文件入库出错");
            }
            log.debug("媒资文件入库完成");
            return RestResponse.success();
        } finally {
    ...
    public void addMediaFilesToMinIO(String filePath, String bucket, String objectName) {
        ...
        try {
            ...
            LearnOnlineException.cast("上传到文件系统出错:" + e.getMessage());
        }
    }
    ...
    private File[] checkChunkStatus(String fileMd5, int chunkTotal) {
        ...
        for (int i = 0; i < chunkTotal; i++) {
            ...
            try {
                ...
                LearnOnlineException.cast("创建临时分块文件出错：" + e.getMessage());
            }
    ...
    public File downloadFileFromMinio(File file, String bucket, String objectName) {
        try (FileOutputStream fileOutputStream = new FileOutputStream(file);
            ...
            LearnOnlineException.cast("查询文件分块出错");
        }
        return null;
    }
    ...
    public void addMediaFilesToMinIO(byte[] bytes, String bucket, String objectName) {
        ...
        try {
            ...
            throw new LearnOnlineException("上传到文件系统出错");
        }
    }
